...
A specialized dashboard for the scientific-mapping system, providing an overview of research activities.

* Features
1. Displays an awesome Emacs banner!
2. Recent documents from the scientific mapping system
3. Citation statistics and database insights
4. Concept relationships and knowledge graph status
5. Recent files
6. Bookmarks list
7. Recent projects list (Depends on `projectile` or `project.el` package)
8. Org mode agenda
9. Register list
10. Supports both [[https://github.com/domtronn/all-the-icons.el][all-the-icons]] and [[https://github.com/rainstormstudio/nerd-icons.el][nerd-icons]]
...
#+BEGIN_SRC shell
  M-x package-install RET scientific-dashboard
#+END_SRC

** Open the Dashboard
You can set up the dashboard to open automatically at startup using =scientific-dashboard-setup-startup-hook=:
#+BEGIN_SRC elisp
...
#+BEGIN_SRC elisp
  ...
  (use-package scientific-dashboard
    :ensure t
    :config
